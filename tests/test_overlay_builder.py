...
import pytest
from apple_ocr.overlay_builder import OverlayComposer, BBoxItem
...
class TestOverlayComposer:
    ...
    def test_norm_to_points_conversion(self):
        ...
        x_pt, y_pt, w_pt, h_pt = OverlayComposer._norm_to_points(
            ...
            width_px=1000, height_px=1000, dpi=300
        )
    ...
    def test_build_overlay_page(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            overlay_bytes = composer._build_overlay_page(
                ...
                items=items, width_px=2000, height_px=2600, dpi=300
            )
    ...
    def test_empty_items_overlay(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            overlay_bytes = composer._build_overlay_page(
                page_width_pt=612, page_height_pt=792,
                items=[], width_px=2000, height_px=2600, dpi=300
            )
